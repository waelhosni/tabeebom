                        ...
                        <Row>
                            ...
                            <div className="pgs-social-profiles mt-4">
                                ...
                                <div className="social-profiles-wrapper-inner social-profiles-default social-profiles-shape-square">
                                    ...
                                    <ul>
                                        <li><a href="https://www.facebook.com/TabeebOman" title="TabeebOman in Facebook" target="_blank"><i className="fa fa-facebook" /></a></li>
                                        <li><a href="https://twitter.com/TabeebOm/" title="TabeebOman in Twitter" target="_blank"><i className="fa fa-twitter" /></a></li>
                                        <li><a href="https://www.instagram.com/tabeeb.oman/" title="TabeebOman in Instagram" target="_blank"><i className="fa fa-instagram" /></a></li>
                                        <li><a href="https://www.youtube.com/channel/UCtDNfY5am1qx3AtvMSVTRsQ" title="TabeebOman in Youtube" target="_blank" ><i className="fa fa-youtube" /></a></li>
                                        <li><a href="https://api.whatsapp.com/send?phone=96897001464" title="TabeebOman in Whatsapp" target="_blank" ><i className="fa fa-whatsapp" /></a></li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
                            ...
                            <div className="footer-nav-menu widget">
                                ...
                                <ul className="menu">
                                    ...
                                    <Router>
                                        <Contactus path="/Contactus/id"  />
                                       
                                    </Router>
                                        <Link to="/Contactus">{t("ContactUs")}</Link>
                                        
                                        </li>
                                    <li className="menu-item"><Link to="/">{t("PrivacyPolicy")}</Link></li>
                            ...
                            <div className="footer-nav-menu widget mt-4 mt-lg-0">
                                ...
                                <ul className="menu">
                                    ...
                                    <li className="menu-item"><Link to="/LoginPage">Login Patient</Link></li>
                                    <li className="menu-item"><Link to="/SignUpPage">Sign Up Patient</Link></li>
                                    <li className="menu-item"><Link to="/LoginPageDoctor">{t("SignIn_Hospital_Doctor")} </Link></li>
                                    <li className="menu-item"><Link to="/SignUpPageDoctor">Sign Up Medical center </Link></li>
                            ...
                            <div className="pgs-contact-widget widget mt-4 mt-lg-0">
                                ...
                                <ul>
                                    <li><i className="fa fa-map-marker" /><span>67 Al-Maha Street Al-Khwair, Near Al Maya Market. Office 13</span></li>
