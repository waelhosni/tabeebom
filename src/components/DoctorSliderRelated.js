...
render(){
    ...
    <div className="loader-wrapper-section " style={{justifyContent:'center'}}>
                                            ...
                                            <div className="product-thumbnail">
                                                ...
                                                {product.OtherImages ?
                                                    <div className="product-thumbnail-swap">
                                                        ...
                                                        alt={product.DoctorName} className="img-fluid doctor-related-slider-img" />
                                                    </div>
                                                    :
                                                    null
                                                }
...
export default withTranslation("translations")(DoctorSliderRelated);
