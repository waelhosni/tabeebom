                ...
                <div className="container">
                    <div className="signup-form-box">
                        <div className="signup-form-top">
                            <h1 className="signup-form-title">Reset Patient Password</h1>
                        ...
                        <p className="already-account d-flex">
                            <Link style={{color:'#1890ff'}} to="/LoginPage">Login Patient</Link>
                            <span>Not a member? <Link style={{color:'#1890ff'}} to="/SignUpPage">Register Patient</Link></span>
                        </p>
                    </div>
                </div>
            </section>
